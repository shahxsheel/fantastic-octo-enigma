...
#ifndef INFINEONPROJECT_SWIFT_H
#define INFINEONPROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InfineonProject",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSData;
SWIFT_CLASS("_TtC15InfineonProject11AppDelegate")
...
SWIFT_CLASS("_TtC15InfineonProject16BluetoothManager")
...
@interface BluetoothManager (SWIFT_EXTENSION(InfineonProject)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BluetoothManager (SWIFT_EXTENSION(InfineonProject)) <CBCentralManagerDelegate>
...
@class UIScene;
SWIFT_CLASS("_TtC15InfineonProject13SceneDelegate")
...
@class CLLocation;
SWIFT_CLASS("_TtC15InfineonProject19UserLocationManager")
