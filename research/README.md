...
- **Headless-friendly** terminal logs (objects + driver status)
...
| `USE_FAKE_GPS` | `0` | Set to `1` to force simulated GPS data from software |
| `USE_FAKE_GYRO` | `0` | Set to `1` to force simulated gyro/accel data from software |
